...
\fbox{ $\overrightarrow{\mathcal{V}_{p \in outil / 0}} = V_{Xp} .\vec{x}_0 + V_{Yp} .\vec{y}_0 + V_{Zp} .\vec{z}_0$ } . En effet, un outil qui se déplace dans une MOCN quelconque aura trois composantes sur trois axes. \\

On peut aussi noté le vecteur vitesse en colonne :
\fbox{
$\overrightarrow{\mathcal{V}_{p \in outil / 0}} =\begin{bmatrix}
V_{xp}\\
V_{yp}\\
V_{zp}
