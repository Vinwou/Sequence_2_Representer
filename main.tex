...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=0.8\textwidth]{Images/result1.png} % Include the figure image
\end{figure}
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1\textwidth]{Images/result2.png} % Include the figure image
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=0.9\textwidth]{Images/equi1.png} % Include the figure image
    \caption{Bilan desau point C.}
	\label{equi1} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1\textwidth]{Images/treuil3.png} % Include the figure image
    \caption{Bilan des actions mécaniques qui s'applique sur la pièce (0) au point C.}
	\label{treuil3} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]\index{Torseurs : notation}  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1.15\textwidth]{Images/treuil4.png} % Include the figure image
    \caption{Écriture du torseur des actions mécanique de (1) sur (0), au point C.}
	\label{treuil4} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
    \fbox{
	\includegraphics[width=0.55\textwidth]{Images/var1.JPG} % Include the figure image
    \includegraphics[width=0.55\textwidth]{Images/var2.JPG } % Include the figure image
     }
	...
	\label{var12} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1\textwidth]{Images/gliss1.png} % Include the figure image
    \caption{Écriture du torseur des actions mécanique de (1) sur (0), au point C.}
	\label{gliss1} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
	\includegraphics[width=1\textwidth]{Images/couple1.png} % Include the figure image
    \caption{Écriture du torseur des actions mécanique de (1) sur (0), au point C.}
	\label{couple1} % Unique label used for referencing the figure in-text
\end{figure}
...
\begin{figure}[H]  % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	\centering % Horizontally center the figure on the page
 \fbox{
	\includegraphics[width=1\textwidth]{Images/treuil2.png} } % Include the figure image
\end{figure}
